...
Route::get('/item/{id}', ViewItem::class)->name('viewItem');
Route::get('/category/{id}', ViewCategory::class)->name('viewCategory');
...
Route::prefix('/admin')->middleware('auth','admin')->group(function() {
    ...
    Route::get('/banners', Banners::class)->name('siteBanners');
});